...
(
  ...
  '+91 54321 09876',
  'Bangalore, Karnataka',
  'Amit Sharma - +91 54321 09877',
  ARRAY['Administration', 'Event Planning', 'Communications'],
  ARRAY['Project Management', 'MS Office', 'Event Planning', 'English', 'Kannada'],
  '8 years in corporate administration and event management',
  'Weekdays after 6 PM, full weekends',
  'I want to use my professional skills to help organize temple activities efficiently.',
  '[{"name": "Mrs. Kavitha Rao", "relation": "Former Manager", "phone": "+91 54321 09878"}, {"name": "Mr. Suresh Kumar", "relation": "Event Coordinator", "phone": "+91 54321 09879"}]'::jsonb,
  'pending',
  'pending',
  false
);
