...
import { CommunityBudgetRequests } from "./tabs/CommunityBudgetRequests";
...
function mapBackendToUI(item: any): Community {
	return {
		...
		status: ((item.status || "active").charAt(0).toUpperCase() +
			(item.status || "active").slice(1)) as Community["status"],
		...
		<div className="space-y-6">
					...
					<div className="space-y-6">
						...
						<div className="flex items-center justify-between flex-wrap gap-4">
							...
							<div className="flex items-center gap-6">
								...
								<div className="text-center">
									<div className="text-2xl font-bold">
										{formatCurrency(community.totalDonations)}
									</div>
						...
						<div className="flex items-center gap-4 text-sm text-muted-foreground pt-4 border-t">
							...
							<span>
								Last activity{" "}
								{formatDistanceToNow(new Date(community.lastActivity), {
									addSuffix: true,
								})}
							</span>
						</div>
			...
			<Tabs
				...
				<TabsContent value="budget">
					<CommunityBudgetRequests community={community} />
				</TabsContent>
