...
import { X, Calendar, Clock, MapPin, User, Bell, Users, Eye, Save } from 'lucide-react';
...
export default function CreatePujaSeriesModal({ isOpen, onClose, onSave, editData, priests, locations }) {
  ...
  }, [formData.recurrenceType, formData.frequency, formData.daysOfWeek, formData.startDate, formData.startTime]);
    ...
    if (formData.recurrenceType === 'daily') {
      for (let i = 0; i < 20; i++) {
        ...
        instances.push({
          ...
          dayOfWeek: instanceDate.toLocaleDateString('en-US', { weekday: 'long' })
        });
      }
    } else if (formData.recurrenceType === 'weekly' && formData.daysOfWeek.length > 0) {
  ...
  const isFormValid = () => {
    return formData.title && formData.location && formData.priest && formData.startTime;
  };
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Select value={formData.priest} onValueChange={(value) => handleInputChange('priest', value)}>
                      <SelectTrigger>
                        <SelectValue placeholder="Select priest" />
                      </SelectTrigger>
                      <SelectContent>
                        {priests.map(priest => (
                          <SelectItem key={`priest-${priest.id}`} value={priest.name}>{priest.name}</SelectItem>
                        ))}
                      </SelectContent>
                    </Select>
                  </div>
                  ...
                  <>
                          ...
                          {DAYS_OF_WEEK.map(day => (
                            <div key={day.value} className="flex items-center space-x-2">
                              <Checkbox
                                ...
                                onCheckedChange={(checked) => handleArrayChange('daysOfWeek', day.value, checked)}
                              />
                    ...
                    {formData.recurrenceType === 'monthly' && (
                      <div>
                        ...
                        <Select value={formData.weekOfMonth} onValueChange={(value) => handleInputChange('weekOfMonth', value)}>
                          <SelectTrigger>
                    ...
                    <div>
                      ...
                      <div className="space-y-3 mt-2">
                        <div className="flex items-center space-x-2">
                          ...
                          />
                          <Label htmlFor="never">Never (continues indefinitely)</Label>
                        </div>
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <Input
                            ...
                            onChange={(e) => handleInputChange('endAfterOccurrences', parseInt(e.target.value))}
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      <Label htmlFor="notifySubscribers">Notify subscribers of schedule</Label>
                      <Switch
                        id="notifySubscribers"
                        checked={formData.notifySubscribers}
                        onCheckedChange={(checked) => handleInputChange('notifySubscribers', checked)}
                      />
                    </div>
                        ...
                        <div className="grid grid-cols-2 gap-2 mt-2">
                          {['30', '15', '5'].map(time => (
                            <div key={time} className="flex items-center space-x-2">
                              ...
                              />
                              <Label htmlFor={`reminder-${time}`} className="text-sm">{time} minutes</Label>
                            </div>
                          ))}
                        </div>
                      </div>
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        onChange={(e) => handleInputChange('customNotificationMessage', e.target.value)}
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) => handleInputChange('allowExceptions', checked)}
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) => handleInputChange('subscriptionEnabled', checked)}
                      />
                    </div>
                  </CardContent>
                </Card>
                ...
                <CardContent>
                  {previewInstances.length > 0 ? (
                    <div className="space-y-4">
                          ...
                          <Card key={index} className="border-l-4 border-l-blue-500">
                            <CardContent className="p-3">
                              <div className="space-y-1 text-sm">
                                ...
                                <div className="text-gray-600">{instance.date}</div>
                      ...
                      <Button variant="outline" size="sm" onClick={generatePreviewInstances}>
                        Generate More
                      </Button>
                    </div>
                  ) : (
