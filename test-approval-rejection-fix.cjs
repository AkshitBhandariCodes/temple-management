...
async function testApprovalRejectionFix() {
    ...
    try {
        ...
        const applicationData = {
            ...
            phone: '+1-555-APPROVAL',
            message: 'Testing approval process',
            why_join: 'Testing approval functionality',
            skills: ['testing', 'approval'],
            experience: 'Approval testing experience'
        };
        ...
        // Find the new member
        const newMember = afterApprovalResponse.data.data.find(m => m.email === 'approval-test@example.com');
        if (newMember) {
